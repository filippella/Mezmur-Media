...
package org.dalol.mezmurmedia.business.binders;
...
import org.dalol.mezmurmedia.mvp.model.adapter.BaseMezmurAdapter;
 ...
 * @since 8/29/2016
 */
public class MezmurCategoryDashboardBinder implements ViewAdapterBinder<String, BaseMezmurAdapter> {

    @Inject
    public MezmurCategoryDashboardBinder() {
    }
