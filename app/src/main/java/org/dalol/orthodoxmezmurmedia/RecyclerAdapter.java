 ...
 */
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.Holder> implements RecyclerViewFastIndexer.BubbleTextGetter {
...
//    public RecyclerAdapter(LayoutInflater inflater, List<Item> items) {
...
//        }
////
////        Log.d(RecyclerAdapter.class.getSimpleName(), mapIndex.toString());
////        Log.d(RecyclerAdapter.class.getSimpleName(), mapIndex.keySet().toString());
////        values = mapIndex.values();
//        //Log.d(RecyclerAdapter.class.getSimpleName(), values.toString());
//    }

    public RecyclerAdapter(LayoutInflater layoutInflater, List<String> items) {
