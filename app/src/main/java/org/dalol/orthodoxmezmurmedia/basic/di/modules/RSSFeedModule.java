...
public class RSSFeedModule {
    ...
    private RSSFeedView mRssFeedView;

    public RSSFeedModule(RSSFeedView feedView) {
        mRssFeedView = feedView;
    }

    @PerJourney
    @Provides
    RSSFeedView provideView() {
        return mRssFeedView;
    }

    @PerJourney
    @Provides
    RSSFeedApi provideApiTask(Retrofit retrofit) {
